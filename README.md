...
```
php composer require prox3000/yii2-gallery "@dev"
```

Или добавить в composer.json

```
"prox3000/yii2-gallery": "@dev",
```
...
```
php yii migrate/up --migrationPath=@vendor/prox3000/yii2-gallery/src/migrations
```
...
```php
    function behaviors()
    {
        return [
            'images' => [
                'class' => 'prox3000\gallery\behaviors\AttachImages',
                'mode' => 'gallery',
                'quality' => 60,
                'galleryId' => 'picture'
            ],
...
```php
<?=\prox3000\gallery\widgets\Gallery::widget(
    [
        'model' => $model,
        'previewSize' => '50x50',
