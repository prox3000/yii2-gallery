<?php
namespace prox3000\gallery\widgets;
...
class Gallery extends \yii\base\Widget
{
    ...
    public function init()
    {
        ...
        \prox3000\gallery\assets\GalleryAsset::register($this->getView());
    }
    ...
    {
        if($image instanceof \prox3000\gallery\models\PlaceHolder) {
            return '';
        }

        $class = ' prox3000-gallery-row';
