<?php
namespace prox3000\gallery\behaviors;

use yii;
use yii\base\Behavior;
use yii\db\ActiveRecord;
use yii\web\UploadedFile;
use prox3000\gallery\models;
use yii\helpers\BaseFileHelper;
use prox3000\gallery\ModuleTrait;
use prox3000\gallery\models\Image;
use prox3000\gallery\models\PlaceHolder;
...
class AttachImages extends Behavior
{
    ...
    public function attachImage($absolutePath, $isMain = false)
    {
        ...
        if ( is_object($img) && get_class($img)=='prox3000\gallery\models\PlaceHolder' or $img == null or $isMain) {
